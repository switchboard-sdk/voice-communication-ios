...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    @IBOutlet weak var playSoundEffectButton: UIButton!
    ...
    @IBAction func playMusicTapped(_ sender: Any) {
        if (audioSystem.isPlaying) {
            audioSystem.pauseMusic()
            playMusicButton.setTitle("Play Music", for: .normal)
        } else {
            audioSystem.playMusic()
            playMusicButton.setTitle("Pause Music", for: .normal)
        }
    }
    
    @IBAction func playSoundEffectTapped(_ sender: Any) {
